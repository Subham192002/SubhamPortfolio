...
export class HomePage {
  ...
  constructor() {
    this.metaService.setMetaTags(
      ...
      'Dive into my portfolio, a passionate software engineer based in the Odisha. Explore the intricacies of my journey, from personal details to exciting projects. Join me on this virtual exploration of technology, creativity, and more.',
      [
        'Subham Kumar Mishra',
        'software engineer',
        'odisha',
