...
@Component({
  ...
  <div class="flex flex-col gap-7">
    ...
    <p class="dark:text-white text-black">
      ...
      <a class="underline" href="https://github.com/Subham192002/SubhamPortfolio" target="_blank"
        >GitHub</a
      >.
    </p>
    ...
    I designed the logo myself, incorporating the first letters of my full name S and Mto create a concise design. The inspiration struck me during a Google search.
    </p>
    <div
